...
<head>
    ...
    <title>Coverage for C:\Users\paper\Anaconda3\Lib\site-packages\torch\multiprocessing\reductions.py: 55%</title>
...
<div id="source">
    ...
    <p id="t29" class="run"><span class="n"><a href="#t29">29</a></span><span class="t">        <span class="nam">self</span><span class="op">.</span><span class="nam">cdata</span> <span class="op">=</span> <span class="nam">storage</span><span class="op">.</span><span class="nam">_weak_ref</span><span class="op">(</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t32" class="run"><span class="n"><a href="#t32">32</a></span><span class="t">        <span class="nam">self</span><span class="op">.</span><span class="nam">_free_weak_ref</span> <span class="op">=</span> <span class="nam">torch</span><span class="op">.</span><span class="nam">Storage</span><span class="op">.</span><span class="nam">_free_weak_ref</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t38" class="run"><span class="n"><a href="#t38">38</a></span><span class="t">        <span class="nam">self</span><span class="op">.</span><span class="nam">_free_weak_ref</span><span class="op">(</span><span class="nam">self</span><span class="op">.</span><span class="nam">cdata</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t58" class="run"><span class="n"><a href="#t58">58</a></span><span class="t">        <span class="nam">dict</span><span class="op">.</span><span class="nam">__setitem__</span><span class="op">(</span><span class="nam">self</span><span class="op">,</span> <span class="nam">key</span><span class="op">,</span> <span class="nam">storage_ref</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t89" class="run"><span class="n"><a href="#t89">89</a></span><span class="t">    <span class="nam">storage_offset</span><span class="op">,</span> <span class="nam">size</span><span class="op">,</span> <span class="nam">stride</span><span class="op">,</span> <span class="nam">requires_grad</span> <span class="op">=</span> <span class="nam">metadata</span>&nbsp;</span><span class="r"></span></p>
    <p id="t90" class="run"><span class="n"><a href="#t90">90</a></span><span class="t">    <span class="nam">t</span> <span class="op">=</span> <span class="nam">torch</span><span class="op">.</span><span class="nam">_utils</span><span class="op">.</span><span class="nam">_rebuild_tensor</span><span class="op">(</span><span class="nam">storage</span><span class="op">,</span> <span class="nam">storage_offset</span><span class="op">,</span> <span class="nam">size</span><span class="op">,</span> <span class="nam">stride</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    <p id="t91" class="run"><span class="n"><a href="#t91">91</a></span><span class="t">    <span class="key">if</span> <span class="nam">cls</span> <span class="op">==</span> <span class="nam">torch</span><span class="op">.</span><span class="nam">nn</span><span class="op">.</span><span class="nam">parameter</span><span class="op">.</span><span class="nam">Parameter</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t97" class="run"><span class="n"><a href="#t97">97</a></span><span class="t">        <span class="nam">t</span><span class="op">.</span><span class="nam">requires_grad</span> <span class="op">=</span> <span class="nam">requires_grad</span>&nbsp;</span><span class="r"></span></p>
    <p id="t98" class="run"><span class="n"><a href="#t98">98</a></span><span class="t">    <span class="key">return</span> <span class="nam">t</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t133" class="run"><span class="n"><a href="#t133">133</a></span><span class="t">    <span class="nam">storage</span> <span class="op">=</span> <span class="nam">tensor</span><span class="op">.</span><span class="nam">storage</span><span class="op">(</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t141" class="run"><span class="n"><a href="#t141">141</a></span><span class="t">    <span class="nam">check_serializing_named_tensor</span><span class="op">(</span><span class="nam">tensor</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    <p id="t142" class="run"><span class="n"><a href="#t142">142</a></span><span class="t">    <span class="nam">torch</span><span class="op">.</span><span class="nam">utils</span><span class="op">.</span><span class="nam">hooks</span><span class="op">.</span><span class="nam">warn_if_has_hooks</span><span class="op">(</span><span class="nam">tensor</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t234" class="run"><span class="n"><a href="#t234">234</a></span><span class="t">    <span class="key">if</span> <span class="nam">storage</span><span class="op">.</span><span class="nam">is_cuda</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t277" class="run"><span class="n"><a href="#t277">277</a></span><span class="t">    <span class="nam">storage_ref</span> <span class="op">=</span> <span class="nam">shared_cache</span><span class="op">.</span><span class="nam">get</span><span class="op">(</span><span class="nam">key</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    <p id="t278" class="run"><span class="n"><a href="#t278">278</a></span><span class="t">    <span class="key">if</span> <span class="nam">storage_ref</span> <span class="key">is</span> <span class="key">None</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t307" class="run"><span class="n"><a href="#t307">307</a></span><span class="t">    <span class="nam">storage</span> <span class="op">=</span> <span class="nam">storage_from_cache</span><span class="op">(</span><span class="nam">cls</span><span class="op">,</span> <span class="nam">handle</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    <p id="t308" class="run"><span class="n"><a href="#t308">308</a></span><span class="t">    <span class="key">if</span> <span class="nam">storage</span> <span class="key">is</span> <span class="key">not</span> <span class="key">None</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t310" class="run"><span class="n"><a href="#t310">310</a></span><span class="t">    <span class="nam">storage</span> <span class="op">=</span> <span class="nam">cls</span><span class="op">.</span><span class="nam">_new_shared_filename</span><span class="op">(</span><span class="nam">manager</span><span class="op">,</span> <span class="nam">handle</span><span class="op">,</span> <span class="nam">size</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    <p id="t311" class="run"><span class="n"><a href="#t311">311</a></span><span class="t">    <span class="nam">shared_cache</span><span class="op">[</span><span class="nam">handle</span><span class="op">]</span> <span class="op">=</span> <span class="nam">StorageWeakRef</span><span class="op">(</span><span class="nam">storage</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    <p id="t312" class="run"><span class="n"><a href="#t312">312</a></span><span class="t">    <span class="key">return</span> <span class="nam">storage</span><span class="op">.</span><span class="nam">_shared_decref</span><span class="op">(</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t320" class="run"><span class="n"><a href="#t320">320</a></span><span class="t">    <span class="key">from</span> <span class="op">.</span> <span class="key">import</span> <span class="nam">get_sharing_strategy</span>&nbsp;</span><span class="r"></span></p>
    <p id="t321" class="run"><span class="n"><a href="#t321">321</a></span><span class="t">    <span class="key">if</span> <span class="nam">storage</span><span class="op">.</span><span class="nam">is_cuda</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t323" class="run"><span class="n"><a href="#t323">323</a></span><span class="t">    <span class="key">elif</span> <span class="nam">get_sharing_strategy</span><span class="op">(</span><span class="op">)</span> <span class="op">==</span> <span class="str">'file_system'</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    <p id="t324" class="run"><span class="n"><a href="#t324">324</a></span><span class="t">        <span class="nam">metadata</span> <span class="op">=</span> <span class="nam">storage</span><span class="op">.</span><span class="nam">_share_filename_</span><span class="op">(</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    <p id="t325" class="run"><span class="n"><a href="#t325">325</a></span><span class="t">        <span class="nam">cache_key</span> <span class="op">=</span> <span class="nam">metadata</span><span class="op">[</span><span class="num">1</span><span class="op">]</span>&nbsp;</span><span class="r"></span></p>
    <p id="t326" class="run"><span class="n"><a href="#t326">326</a></span><span class="t">        <span class="nam">rebuild</span> <span class="op">=</span> <span class="nam">rebuild_storage_filename</span>&nbsp;</span><span class="r"></span></p>
    <p id="t327" class="run"><span class="n"><a href="#t327">327</a></span><span class="t">        <span class="nam">storage</span><span class="op">.</span><span class="nam">_shared_incref</span><span class="op">(</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t342" class="run"><span class="n"><a href="#t342">342</a></span><span class="t">    <span class="nam">shared_cache</span><span class="op">[</span><span class="nam">cache_key</span><span class="op">]</span> <span class="op">=</span> <span class="nam">StorageWeakRef</span><span class="op">(</span><span class="nam">storage</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
    <p id="t343" class="run"><span class="n"><a href="#t343">343</a></span><span class="t">    <span class="key">return</span> <span class="op">(</span><span class="nam">rebuild</span><span class="op">,</span> <span class="op">(</span><span class="nam">type</span><span class="op">(</span><span class="nam">storage</span><span class="op">)</span><span class="op">,</span><span class="op">)</span> <span class="op">+</span> <span class="nam">metadata</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
