...
<head>
    ...
    <title>Coverage for C:\Users\paper\Anaconda3\Lib\site-packages\torch\utils\data\_utils\signal_handling.py: 41%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>C:\Users\paper\Anaconda3\Lib\site-packages\torch\utils\data\_utils\signal_handling.py</b> :
...
<div id="source">
    ...
    <p id="t33" class="run"><span class="n"><a href="#t33">33</a></span><span class="t"><span class="key">import</span> <span class="nam">signal</span>&nbsp;</span><span class="r"></span></p>
    <p id="t34" class="run"><span class="n"><a href="#t34">34</a></span><span class="t"><span class="key">import</span> <span class="nam">threading</span>&nbsp;</span><span class="r"></span></p>
    <p id="t35" class="run"><span class="n"><a href="#t35">35</a></span><span class="t"><span class="key">from</span> <span class="op">.</span> <span class="key">import</span> <span class="nam">IS_WINDOWS</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t39" class="run"><span class="n"><a href="#t39">39</a></span><span class="t"><span class="key">from</span> <span class="nam">torch</span><span class="op">.</span><span class="nam">_C</span> <span class="key">import</span> <span class="nam">_set_worker_pids</span><span class="op">,</span> <span class="nam">_remove_worker_pids</span>  <span class="com"># noqa: F401</span>&nbsp;</span><span class="r"></span></p>
    <p id="t40" class="run"><span class="n"><a href="#t40">40</a></span><span class="t"><span class="key">from</span> <span class="nam">torch</span><span class="op">.</span><span class="nam">_C</span> <span class="key">import</span> <span class="nam">_error_if_any_worker_fails</span><span class="op">,</span> <span class="nam">_set_worker_signal_handlers</span>  <span class="com"># noqa: F401</span>&nbsp;</span><span class="r"></span></p>
    <p id="t41" class="pln"><span class="n"><a href="#t41">41</a></span><span class="t">&nbsp;</span><span class="r"></span></p>
    <p id="t42" class="run"><span class="n"><a href="#t42">42</a></span><span class="t"><span class="nam">_SIGCHLD_handler_set</span> <span class="op">=</span> <span class="key">False</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t47" class="run"><span class="n"><a href="#t47">47</a></span><span class="t"><span class="key">def</span> <span class="nam">_set_SIGCHLD_handler</span><span class="op">(</span><span class="op">)</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t49" class="run"><span class="n"><a href="#t49">49</a></span><span class="t">    <span class="key">if</span> <span class="nam">IS_WINDOWS</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
